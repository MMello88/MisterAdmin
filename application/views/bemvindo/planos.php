...
<link href="<?= base_url('assets/templateV3/css/now-ui-kit.min.css?v=1.2.2') ?>" rel="stylesheet" />

<!-- CSS Just for demo purpose, don't include it in your project -->
<link href="<?= base_url('assets/templateV3/css/demoV2.css') ?>" rel="stylesheet" />
</head>
...
<nav class="navbar navbar-expand-lg bg-white fixed-top navbar-transparent" color-on-scroll="500">
	<div class="container">
	    ...
	    <div class="collapse navbar-collapse" data-nav-image="<?= base_url('assets/templateV3/img/blurred-image-1.jpg') ?>" data-color="orange">
...
<!-- End Navbar -->
    ...
    <div class="page-header-image"  style="background-image: url('<?= base_url('assets/templateV3/img/bg37.jpg') ?>');">
    </div>
...
<div class="contactus-1 section-image" style="background-image: url('<?= base_url('assets/templateV3/img/bg27.jpg') ?>')">
    <div class="container">
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 pr-2">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" placeholder="First Name..." autocomplete="name">
                                    </div>
                                </div>
...
<!--  Plugin for the DatePicker, full documentation here: https://github.com/uxsolutions/bootstrap-datepicker -->
<script src="<?= base_url('assets/templateV3/js/plugins/moment.min.js') ?>"></script>
<!--	Plugin for Tags, full documentation here: https://github.com/bootstrap-tagsinput/bootstrap-tagsinputs  -->
<script src="<?= base_url('assets/templateV3/js/plugins/bootstrap-tagsinput.js') ?>"></script>
<!--	Plugin for Select, full documentation here: http://silviomoreto.github.io/bootstrap-select -->
<script src="<?= base_url('assets/templateV3/js/plugins/bootstrap-selectpicker.js') ?>" type="text/javascript"></script>
<!--  Plugin for the DateTimePicker, full documentation here: https://eonasdan.github.io/bootstrap-datetimepicker/ -->
<script src="<?= base_url('assets/templateV3/js/plugins/bootstrap-datetimepicker.js') ?>" type="text/javascript"></script>
<!-- Sharrre libray -->
<script src="<?= base_url('assets/templateV3/js/plugins/jquery.sharrre.js') ?>"></script>
