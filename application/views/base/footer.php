  ...
  se usar o circle colocar um if
  ...
  se usar o circle colocar um if FIM 
  */ ?>
  <?php /*
   se usar o morris-chart colocar um if 
  ...
  <script src="<?= base_url('assets/templateGrocery/tamplate_focus/assets/js/lib/morris-chart/morris-init.js'); ?>"></script>
   se usar o morris-chart colocar um if FIM
  */ ?>
  <?php /*
  se usar o flot-chart colocar um if 
    flot-chart js 
  ...
  <script src="<?= base_url('assets/templateGrocery/tamplate_focus/assets/js/lib/flot-chart/flot-chart-init.js'); ?>"></script>
   // flot-chart js 
   se usar o flot-chart colocar um if FIM
  */ ?>
  <?php /*
   se usar o vector-map colocar um if 
  ...
  se usar o vector-map colocar um if FIM
  */ ?>
  <?php /*
   se usar o country colocar um if 
