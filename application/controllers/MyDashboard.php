...
class MyDashboard extends CI_Controller {
	...
	public function PagarAConta(){
		...
		$crud->fields('id_contas_apagar', 'tipo_pagamento', 'dt_venc', 'dt_pago', 'valor_apagar', 
			'valor_pgto', 'valor_desconto', 'valor_juros', 'conta_fixa', 'situacao', 'id_contas_apagar', 
			'id_fornecedor', 'id_classificacao');
	...
	public function ContasPagas(){
		...
		$crud->set_subject('Pagar A Contas');
		$crud->columns('id_fornecedor', 'id_classificacao', 'dt_venc', 'valor_apagar', 'tipo_pagamento', 'dt_pago', 'valor_apagar');
		$crud->fields('id_contas_apagar', 'tipo_pagamento', 'dt_venc', 'dt_pago', 'valor_apagar', 
			'valor_pgto', 'valor_desconto', 'valor_juros', 'conta_fixa', 'situacao', 'id_contas_apagar', 
			'id_fornecedor', 'id_classificacao');
