...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='Cadastro dos itens do pedido para salgado';
...
insert  into `tbl_estoque`(`id_estoque`,`id_loja`,`id_produto`,`qtde_total`,`qtde_minima`) values (1,1,2,10,25),(2,1,14,25,25);
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='Tabela de movimentação de produto';

/*Data for the table `tbl_ficha_kardex` */

LOCK TABLES `tbl_ficha_kardex` WRITE;

insert  into `tbl_ficha_kardex`(`id_ficha_kerdex`,`id_loja`,`id_produto`,`tipo_movimentacao`,`origem_movimentacao`,`data_movimentacao`,`qtde_movimentacao`) values (1,1,2,'e','me','2018-07-16',10),(2,1,2,'e','me','2018-07-16',100),(3,1,2,'s','me','2018-07-16',25),(4,1,14,'e','me','2018-07-16',200),(7,1,14,'s','ps','2018-07-16',10),(8,1,2,'e','me','2018-07-16',10),(9,1,14,'e','me','2018-07-16',10),(10,1,14,'e','me','2018-07-16',20),(11,1,14,'s','ps','2018-07-16',20),(12,1,14,'e','me','2018-07-16',100),(13,1,2,'e','me','2018-07-16',100),(14,1,14,'s','ps','2018-07-16',50),(15,1,14,'s','ps','2018-07-16',20),(16,1,2,'e','me','2018-07-16',50),(17,1,2,'s','me','2018-07-16',45),(18,1,2,'e','me','2018-07-16',10),(19,1,2,'s','me','2018-07-17',200),(20,1,14,'s','me','2018-07-17',205);
...
) ENGINE=InnoDB AUTO_INCREMENT=75 DEFAULT CHARSET=utf8 COMMENT='Cadastro dos itens do pedido para salgado';

/*Data for the table `tbl_item_pedido` */

LOCK TABLES `tbl_item_pedido` WRITE;

insert  into `tbl_item_pedido`(`id_item_pedido`,`id_pedido`,`id_produto`,`qtde`,`valor_unitario`) values (66,75,39,10,0.45),(67,75,14,40,0.40),(68,76,14,10,0.45),(69,77,14,10,0.45),(70,78,14,10,0.45),(71,79,14,10,0.45),(72,80,14,20,0.45),(73,81,14,50,0.45),(74,82,14,20,0.45);
...
insert  into `tbl_movimentacao_estoque`(`id_movimentacao_estoque`,`id_loja`,`id_produto`,`tipo_movimentacao`,`qtde_movimentacao`,`data_movimentacao`) values (1,1,2,'e',10,'2018-07-16 17:45:09'),(2,1,2,'e',100,'2018-07-16 17:47:36'),(3,1,2,'s',25,'2018-07-16 17:50:03'),(4,1,14,'e',200,'2018-07-16 17:54:26'),(8,1,14,'s',10,'2018-07-16 13:25:43'),(9,1,2,'e',10,'2018-07-16 20:54:38'),(10,1,14,'e',10,'2018-07-16 20:56:05'),(11,1,14,'e',20,'2018-07-16 20:56:25'),(12,1,14,'s',20,'2018-07-16 16:20:53'),(13,1,14,'e',100,'2018-07-16 21:31:30'),(14,1,2,'e',100,'2018-07-16 21:31:37'),(15,1,14,'s',50,'2018-07-16 17:16:02'),(16,1,14,'s',20,'2018-07-16 17:17:09'),(17,1,2,'e',50,'2018-07-16 22:29:35'),(18,1,2,'s',45,'2018-07-16 22:31:27'),(19,1,2,'e',10,'2018-07-16 22:31:33'),(20,1,2,'s',200,'2018-07-17 00:14:31'),(21,1,14,'s',205,'2018-07-17 00:33:28');
